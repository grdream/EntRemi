...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}"
      x-data="{ darkMode: localStorage.getItem('darkMode') !== null ? localStorage.getItem('darkMode') === 'true' : {{ auth()->check() && auth()->user()->dark_mode ? 'true' : 'false' }} }"
    ...
    <body class="font-sans antialiased" x-data="{ sidebarOpen: true, mobileSidebarOpen: false }">
        <div class="min-h-screen bg-surface-50 dark:bg-surface-950 bg-mesh-gradient transition-colors duration-300">
            ...
            {{-- Main Content Area --}}
            <div class="transition-all duration-300 lg:ml-[272px]" :class="{ 'lg:ml-[72px]': !sidebarOpen, 'lg:ml-[272px]': sidebarOpen }">
